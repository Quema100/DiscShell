...
* [Usage](#usage)
    * [1. Bot Token Configuration](#1-Bot-Token-Configuration)
    * [2. Open Discord](#2-open-discord)
    * [3. Use Slash Commands](#3-use-slash-commands)
    * [4. Execute Commands on Endpoints](#4-execute-commands-on-endpoints)
